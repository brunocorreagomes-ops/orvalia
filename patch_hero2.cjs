...
content = content.replace(
  /<div className="absolute top-1\/4 -right-1\/4 w-\[80vw\] md:w-\[40vw\] h-\[80vw\] md:h-\[40vw\] bg-brand-accent-dark\/10 rounded-full blur-\[100px\] md:blur-\[150px\] opacity-50 mix-blend-screen animate-float" \/>/g, 
