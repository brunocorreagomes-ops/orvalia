      ...
      <div className="container mx-auto px-6">
        ...
        <div className="dna-grid mb-32 md:mb-48">
          ...
          <motion.div
             ...
             viewport={{ once: true }}
             className="col-span-4 lg:col-span-5 flex flex-col justify-end pt-8 lg:pt-0"
          >
            <div className="glass-premium p-8 md:p-10 rounded-[2.5rem] md:rounded-[3rem] relative space-y-6 md:space-y-8">
              <div className="flex gap-4 md:gap-6 items-start">
                 ...
                 <div>
                    ...
                    <p className="text-brand-secondary/60 text-[9px] md:text-xs leading-relaxed font-mono">ESTRATÉGIAS DE POSICIONAMENTO PARA PÚBLICOS DE ALTO VALOR.</p>
                 </div>
              </div>
        ...
        >
          <div className="absolute inset-0 bg-brand-accent-light/5 blur-[100px] rounded-full opacity-30" />
           <div className="relative border border-white/10 bg-brand-bg md:p-24 p-8 rounded-[3rem] md:rounded-[4rem] overflow-hidden">
             <div className="absolute top-0 right-0 p-8 md:p-12 opacity-10">
                <ShieldCheck size={80} className="text-white md:w-[120px] md:h-[120px]" />
             </div>
             
             <div className="relative z-10 flex flex-col lg:grid lg:grid-cols-12 gap-8 items-center">
                <div className="col-span-12 lg:col-span-8">
                  <h3 className="text-2xl md:text-5xl font-black text-white mb-6 md:mb-8 tracking-tight">O que é Branding Estratégico?</h3>
                  <p className="text-brand-secondary text-base md:text-lg leading-relaxed mb-8 md:mb-10">
