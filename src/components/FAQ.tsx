...
function FAQItem({ question, answer, isOpen, onClick }: { question: string, answer: string, isOpen: boolean, onClick: () => void }) {
  return (
    <div className="border-b border-white/10">
      ...
      >
        <span className="text-lg xs:text-xl md:text-2xl font-black uppercase tracking-tight text-white group-hover:text-brand-accent-light transition-colors pr-8">
          {question}
        </span>
