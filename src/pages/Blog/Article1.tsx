      ...
      <div className="max-w-4xl mx-auto">
        ...
        <header className="mb-16">
          <motion.span 
            ...
            className="text-brand-accent-light text-[10px] font-black uppercase tracking-[0.4em] block mb-6 md:mb-8"
          >
            Branding & Estratégia
          </motion.span>
          <motion.h1 
            ...
            className="text-[clamp(2.6rem,4vw,4.4rem)] font-sans font-black text-white tracking-[-0.03em] leading-[0.98] mb-12 max-w-[12ch] md:max-w-[14ch]"
          >
        ...
        >
          <BlogImage src="https://i.ibb.co/dsKJRZVN/05-branding-em-indaiatuba-como-construir-uma-marca-forte.webp" alt="Branding em Indaiatuba:" caption="O segredo para uma marca inesquecível" />
        </motion.div>
