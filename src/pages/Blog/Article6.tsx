  ...
  return (
    <article className="min-h-screen bg-brand-bg text-brand-text pt-40 pb-20 px-8 md:px-24">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <BlogImage src="https://i.ibb.co/jPfp3h9W/10-criacao-de-site-profissional-da-usabilidade-a-conversao.webp" alt="Criação de site profissional" caption="Transforme visitantes em clientes fiéis" />
        </motion.div>
        ...
        <div className="prose prose-invert prose-xl max-w-none text-brand-secondary leading-relaxed space-y-8 font-sans selection:bg-brand-surface selection:text-white">
          ...
          <div className="p-8 md:p-12 bg-white/5 border border-gray-100 rounded-[2.5rem] shadow-[0_20px_40px_rgba(0,0,0,0.02)] my-16">
            <h3 className="text-2xl font-black text-brand-text tracking-tighter mb-8 uppercase">Um site profissional hoje precisa unir três pilares:</h3>
            <ul className="space-y-4 list-none p-0">
              <li className="flex gap-4">
                <span className="font-mono text-brand-text font-black">1. //</span>
                <div>
                  <strong className="text-brand-text block mb-1">Clareza (UX)</strong>
                  <span className="text-brand-secondary">O visitante entende rapidamente o que você faz e como contratar.</span>
                </div>
              </li>
              <li className="flex gap-4">
                <span className="font-mono text-brand-text font-black">2. //</span>
                <div>
                  <strong className="text-brand-text block mb-1">Posicionamento (Branding)</strong>
                  <span className="text-brand-secondary">Transmite valor, autoridade e profissionalismo.</span>
                </div>
              </li>
              <li className="flex gap-4">
                <span className="font-mono text-brand-text font-black">3. //</span>
                <div>
                  <strong className="text-brand-text block mb-1">Conversão (Marketing)</strong>
                  <span className="text-brand-secondary">Estrutura focada em guiar o usuário para a ação.</span>
                </div>
              </li>
            </ul>
          </div>
          ...
          <p>Para construir essa presença sólida, confira nosso <Link to="/blog/guia-marca-forte" className="text-brand-text font-semibold underline decoration-brand-accent-light/30 hover:decoration-brand-accent-light transition-all">guia completo de construção de marca digital</Link>.</p>
        </div>
...
<div className="relative z-10">
            <h3 className="text-3xl md:text-5xl font-black text-brand-text tracking-ultra-tight uppercase mb-8 leading-[0.9]">Seu site atual converte ou apenas existe?</h3>
            <a 
