  ...
  return (
    <article className="min-h-screen bg-brand-bg text-brand-text pt-40 pb-20 px-8 md:px-24">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <BlogImage src="https://i.ibb.co/mrW1xwFV/01-arquitetura-de-sites-de-alto-padrao-em-campinas-e-rmc.webp" alt="Arquitetura de Sites de Alto Padrão em Campinas e RMC" caption="Arquitetura invisível, resultados palpáveis" />
        </motion.div>
