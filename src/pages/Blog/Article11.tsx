  ...
  return (
    <article className="min-h-screen bg-brand-bg text-brand-text pt-40 pb-20 px-8 md:px-24">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <BlogImage src="https://i.ibb.co/nsKZ4K3f/15-branding-estrategico-o-caminho-para-o-posicionamento-premium.webp" alt="Branding Estratégico:" caption="Crie desejo de compra através do Design" />
        </motion.div>
