    ...
    <section className="min-h-screen bg-brand-bg pt-32 md:pt-40 pb-20 px-6 md:px-12 lg:px-24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20">
        <div>
          ...
          <a 
            href="https://wa.me/5511978959567?text=Olá!%20Gostaria%20de%20contratar%20o%20Plano%20Profissional%20pela%20Orvalia%20Studio."
        ...
        <div className="space-y-10 md:space-y-12">
          <div className="glass p-8 md:p-12 rounded-[2.5rem] md:rounded-[3rem] border border-brand-accent-light/20 glow-subtle">
